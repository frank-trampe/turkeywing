	...
	user_overlay: {
		...
		fields: {
			...
			/* BEGIN SPDAT FIELDS - note, there might be some overlap with VI-SPDAT form */
			  ...
			  30_days: {type: 'number', required: 1, allow_null: 1, human_name: "30_days"},
			  3_months: {type: 'number', required: 1, allow_null: 1, human_name: "3_months"},
			  6_months: {type: 'number', required: 1, allow_null: 1, human_name: "6_months"},
			  9_months: {type: 'number', required: 1, allow_null: 1, human_name: "9_months"},
			  12_months: {type: 'number', required: 1, allow_null: 1, human_name: "12_months"},
			  15_months: {type: 'number', required: 1, allow_null: 1, human_name: "15_months"},
			  18_months: {type: 'number', required: 1, allow_null: 1, human_name: "18_months"},
			  21_months: {type: 'number', required: 1, allow_null: 1, human_name: "21_months"},
			  24_months: {type: 'number', required: 1, allow_null: 1, human_name: "24_months"},
			/* END SPDAT FIELDS */
			/* BEGIN VI-SPDAT FIELDS */
			  ...
			  Medical_Condition_and_Substances: {type: 'number', required: 1, allow_null: 1, human_name: "IF THE FAMILY SCORED 1 EACH FOR PHYSICAL HEALTH, SUBSTANCE USE, AND MENTAL HEALTH:Does any single member of your household have a medical condition, mental health concerns, and experience with problematic substance use?"},
			  ...
			  3_hours_afterschool: {type: 'number', required: 1, allow_null: 1, human_name: "After school, or on weekends or days when there isn’t school, is the total time children spend each day where there is no interaction with you or another responsible adult 3 or more hours per day for children aged 13 or older?"},
			  2_hours_afterschool: {type: 'number', required: 1, allow_null: 1, human_name: "After school, or on weekends or days when there isn’t school, is the total time children spend each day where there is no interaction with you or another responsible adult 2 or more hours per day for children aged 12 or younger?"},
			  2_hours_helping: {type: 'number', required: 1, allow_null: 1, human_name: "IF THERE ARE CHILDREN BOTH 12 AND UNDER & 13 AND OVER:Do your older kids spend 2 or more hours on a typical day helping their younger sibling(s) with things like getting ready for school, helping with homework, making them dinner, bathing them, or anything like that?"}
			/* END VI-SPDAT FIELDS */
